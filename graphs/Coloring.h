...
vertex coloring problems sees to assign a label (or color) to each vertex of a graph sch that no edge links any two vertices of the same color.  We can easily avoid all conflicts by assigning each vertex a unique color.  
